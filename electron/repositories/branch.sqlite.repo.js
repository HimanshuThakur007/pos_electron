...
const TEMP_TABLE_NAME = "branches_temp";

/* ======================================================
   CREATE TEMP TABLE (SQLite)
====================================================== */
export const createTempBranchTableSqlite = (sampleItem) => {
  try {
    if (!sampleItem) {
    ...
    console.error("❌ SQLite Create Branch Table Error:", err.message);
    throw err;
  }
};
...
====================================================== */
export const insertBranchesBulkSqlite = (items) => {
  ...
  try {
    ...
    console.error("❌ SQLite Insert Branches Error:", err.message);
    throw err;
  }
};
...
====================================================== */
export const swapBranchTablesSqlite = () => {
  try {
    ...
    console.error("❌ SQLite Swap Branches Error:", err.message);
    throw err;
  }
};
